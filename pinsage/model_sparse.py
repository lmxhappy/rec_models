...
class PinSAGEModel(nn.Module):
    ...
    def forward(self, pos_graph, neg_graph, blocks, item_emb):
        ...
        pos_score = self.scorer(pos_graph, h_item) # [32,1]
        neg_score = self.scorer(neg_graph, h_item) #[32,1]
        return (neg_score - pos_score + 1).clamp(min=0) #relu, hinge loss
    ...
    def get_repr(self, blocks, item_emb):
        ...
        tmp = item_emb(blocks[0].srcdata[dgl.NID].cpu())
        tmp2 = tmp.to(h_item)
