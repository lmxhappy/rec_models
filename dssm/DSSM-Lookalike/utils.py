...
class CosinePredictionLayer(Layer):
    """
      Arguments
    ...
    def __init__(self, **kwargs):
        super(CosinePredictionLayer, self).__init__(**kwargs)

    def build(self, input_shape):
        super(CosinePredictionLayer, self).build(input_shape)
    ...
    def get_config(self, ):
        config = {}
        base_config = super(CosinePredictionLayer, self).get_config()
